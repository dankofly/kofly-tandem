    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-8 right-8 z-50 hidden lg:flex items-center gap-2 pl-4 pr-5 py-3 rounded-full bg-accent-500 hover:bg-accent-400 text-white btn-glow transition-all duration-300 hover:scale-105 shadow-lg"

    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-24 right-4 sm:bottom-8 sm:right-8 z-50 flex items-center gap-2 pl-4 pr-5 py-3 rounded-full bg-accent-500 hover:bg-accent-400 text-white btn-glow transition-all duration-300 hover:scale-105 shadow-lg"
        ...
        >
          ...
          <span className="text-sm font-semibold tracking-wide">Kofly KI</span>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-4 sm:bottom-8 sm:right-8 z-50 w-[calc(100vw-2rem)] max-w-[380px] h-[min(500px,calc(100vh-8rem))] flex flex-col glass-card rounded-2xl shadow-2xl border border-edge-faint overflow-hidden animate-fade-in-up">
          {/* Header */}

  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-5 sm:px-6 text-center sm:text-left">
        ...
        <div className="hero-enter hero-enter-4 mt-8 hidden sm:inline-flex flex-col gap-3" role="group" aria-label={t("ctaGroupLabel")}>
          <div className="flex flex-row gap-3">
            <Link
              href="/buchen"
              className="cta-lift btn-glow btn-press inline-flex items-center justify-center px-10 py-4 rounded-lg bg-accent-500 hover:bg-accent-400 text-white font-bold text-sm tracking-wide uppercase transition-all duration-300 min-h-[48px]"
            >
              {t("ctaBook")}
            </Link>
            <Link
              href="/buchen#gutschein"
              className="cta-lift btn-press inline-flex items-center justify-center px-10 py-4 rounded-lg border border-[var(--hero-border)] hover:border-[var(--hero-border-hover)] text-hero-secondary hover:text-hero font-semibold text-sm tracking-wide uppercase transition-all duration-300 min-h-[48px]"
            >
              {t("ctaVoucher")}
            </Link>
          </div>

          ...
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <ul className="mt-5 space-y-2.5 flex-1">
                {pkg.features.map((f) => (
                  <li key={f} className="flex items-start gap-2 text-[13px] text-content-body font-normal leading-relaxed">
                    <span className="w-1 h-1 rounded-full bg-accent-500 mt-1.5 flex-shrink-0" aria-hidden="true" />
                    {f}
                  </li>
                ))}
              </ul>
              ...
              <Link
                href="/buchen"
                className={`mt-6 block text-center px-6 py-3 rounded-lg text-[13px] font-semibold tracking-wide uppercase transition-all duration-300 ${
                  pkg.highlighted
              ...
              <a
                ...
                className="mt-2 flex items-center justify-center gap-1.5 text-xs text-[#25D366]/70 hover:text-[#25D366] font-semibold tracking-wide transition-colors"
              >

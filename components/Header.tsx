        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-1 lg:hidden">
            ...
            >
              ...
              <span className="absolute top-1 left-2 w-2 h-2 rounded-full bg-green-500 animate-ping" />
              <span className="absolute top-1 left-2 w-2 h-2 rounded-full bg-green-500" />

            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-content-primary">
                  {t("tandemFromPustertalTitle")}
                </h3>
              </div>
              <p className="text-sm sm:text-base text-content-body leading-relaxed font-light">
                {t("tandemFromPustertalP")}
              </p>
          ...
          <div className="mt-12 relative overflow-hidden glass-card border-accent-500/30 p-8 sm:p-12">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-content-primary">
                  {t("tandemFromIseltalTitle")}
                </h3>
              </div>
              <p className="text-sm sm:text-base text-content-body leading-relaxed font-light">
                {t("tandemFromIseltalP")}
              </p>
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <Link
                  href="/buchen"

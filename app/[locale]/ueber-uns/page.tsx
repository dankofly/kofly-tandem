    ...
    <>
      ...
      <section className="py-20 lg:py-28 bg-surface-secondary relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          {/* Values – visual cards with icons & accent border */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                title: "Leidenschaft",
                text: "Paragleiten als Berufung und sehr viel Erfahrung",
              },
              {
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                title: "Kommunikation",
                text: "Ruhig, klar und auf Augenhöhe",
              },
              {
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                title: "Betreuung",
                text: "Persönlich vom ersten Kontakt bis zur Landung",
              },
              {
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                text: "Höchste Flexibilität – individuell auf dich angepasst",
              },
            ].map((value, i) => (
              <ScrollReveal key={i} animation="fade-up" delay={i * 100}>
                <div className="step-card glass-card card-hover-glow p-6 h-full">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 rounded-full bg-accent-500/10 border border-accent-500/20 flex items-center justify-center text-accent-500 shrink-0">
                      {value.icon}
                    </div>
                    <h4 className="text-sm font-semibold text-content-primary tracking-wide">
                      {value.title}
                    </h4>
                  </div>
                  <p className="text-sm text-content-body leading-relaxed font-light pl-[52px]">
                    {value.text}
                  </p>
                </div>
              </ScrollReveal>

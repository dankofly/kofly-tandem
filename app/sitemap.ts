...
const pages = [
  ...
  { path: "/urlaub", changeFrequency: "monthly" as const, priority: 0.7 },
  { path: "/anreise", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/paragleiten", changeFrequency: "monthly" as const, priority: 0.7 },
